...
def deal # to player
    deal # to dealer down card
    deal # to player
    deal # to dealer card up
def calculate_hand_values_before_dealers_turn # calculate players hand value and dealers up card value
def display_hand_values_before_dealers_turn # display players full hand value and dealers upcard value
def display_players_hand_before_dealers_turn # first_deal_values? 2 player and 1 dealer up and 1 dealer down
    loop do # players hand
def twenty_one? => false
#   player_twenty_one? => true
# def display_twenty_one => "!! TWENTY ONE !!"
#   display_hand_values_before_dealers_turn # player 21 dealer 
# break players hand loop 
def hit? => true
    deal # another card to player
    calculate_hand_values_before_dealers_turn
    display_hand_values_before_dealers_turn 
    player_21? => false
    busted? => false
...
# def display_dealers_hand  # players hand and dealers full hand
#     calculate_hand_value_when_dealer_reveals_down_card # dealers total hand value
#     display_hand_values_after_dealer_reveals_down_card # display values for player over 21, 
...
def display_dealers_hand # players hand and show dealers full hand
def calculate_values_of_dealers_full_hand_and_players_hand
    display_dealer_and_player_score # with dealers hand added in now
    dealer_21? => false
    hit? => true
    display_player_and_dealers_hand
    display_dealer_and_player_score
    calculate_values_of_dealers_full_hand_and_players_hand
    dealer_push? => false
    dealer_21? => false
    busted? => false
    hit? => true
    display_player_and_dealers_hand
    calculate_values_of_dealers_full_hand_and_players_hand
    display_dealer_and_player_score => player 18  dealer 20
    dealer_push? => false
    dealer_21? => false
    dealer_bust? => false
    hit? => false
...
SCENARIO: DEALER HAS 1 POINT  - NEITHER PLAYER NOR DEALER WON THE GAME
  calculate_who_won_hand? => Dealer 
  puts "Dealer won that hand"
  calculate_game_score => dealer # += 1  player 0   dealer 1
